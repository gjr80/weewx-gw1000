...
class Gw1000Collector(Collector):
    ...
    class Parser(object):
        ...
        response_struct = {
            ...
            b'\x03': ('decode_temp', 2, 'dewpoint'),  # Dew point (C), size in bytes:2
            b'\x04': ('decode_temp', 2, 'windchill'),  # Wind chill (C), size in bytes:2
            b'\x05': ('decode_temp', 2, 'heatindex'),  # Heat index (C), size in bytes:2
            b'\x06': ('decode_humid', 1, 'inhumid'),  # Indoor Humidity (%), size in bytes:1
            b'\x07': ('decode_humid', 1, 'outhumid'),
            b'\x08': ('decode_press', 2, 'absbarometer'),
            b'\x09': ('decode_press', 2, 'relbarometer'),
            b'\x0A': ('decode_dir', 2, 'winddir'),  # Wind Direction (360), size in bytes:2
            b'\x0B': ('decode_speed', 2, 'windspeed'),  # Wind Speed (m/s), size in bytes:2
            b'\x0C': ('decode_speed', 2, 'gustspeed'),  # Gust Speed (m/s), size in bytes:2
            b'\x0D': ('decode_rain', 2, 'rainevent'),  # Rain Event (mm), size in bytes:2
            b'\x0E': ('decode_rainrate', 2, 'rainrate'),  # Rain Rate (mm/h), size in bytes:2
            b'\x0F': ('decode_rain', 2, 'rainhour'),  # Rain hour (mm), size in bytes:2
            b'\x10': ('decode_rain', 2, 'rainday'),  # Rain Day (mm), size in bytes:2
            b'\x11': ('decode_rain', 2, 'rainweek'),  # Rain Week (mm), size in bytes:2
            b'\x12': ('decode_big_rain', 4, 'rainmonth'),  # Rain Month (mm), size in bytes:4
            b'\x13': ('decode_big_rain', 4, 'rainyear'),  # Rain Year (mm), size in bytes:4
            b'\x14': ('decode_big_rain', 4, 'raintotals'),  # Rain Totals (mm), size in bytes:4
            b'\x15': ('decode_light', 4, 'light'),  # Light  (lux), size in bytes:4
        ...
        def decode_batt(self, data, field):
            ...
            representations. WH24, WH25, WH26(WH32), WH31, WH40, WH41 and WH51
