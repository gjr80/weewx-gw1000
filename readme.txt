...
method):
    ...
    -   download the GW1000 driver extension package:
        ...
        $ wget -P /var/tmp https://github.com/gjr80/weewx-gw1000/releases/download/v0.1.0b7/gw1000-0.1.0b7.tar.gz

    -   install the GW1000 driver extension:

        $ wee_extension --install=/var/tmp/gw1000-0.1.0b7.tar.gz
...
3.  If installing manually:
    ...
    -   extract the contents of the GW1000 driver extension package:
        ...
        $ tar -xzf /var/tmp/gw1000-0.1.0b7.tar.gz -C /var/tmp
